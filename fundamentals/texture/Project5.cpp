...
int		VenusDL, EarthDL, MarsDL, JupiterDL, SaturnDL, UranusDL, NeptuneDL;
...
Display( )
{
	...
	SetPointLight(GL_LIGHT0, xlight, ylight, 10, 1., 1., 1.);
	...
	if (NowPlanet == MARS)
		glCallList(MarsDL);
	else if (NowPlanet == VENUS)
		glCallList(VenusDL);
	else if (NowPlanet == EARTH)
		glCallList(EarthDL);
	else if (NowPlanet == JUP)
		glCallList(JupiterDL);
	else if (NowPlanet == SAT)
		glCallList(SaturnDL);
	else if (NowPlanet == URA)
		glCallList(UranusDL);
	else if (NowPlanet == NEP)
...
InitGraphics( )
{
	...
	int width, height, width1, height1, width2, height2, width3, height3, width4, height4, width5, height5, width6, height6;
